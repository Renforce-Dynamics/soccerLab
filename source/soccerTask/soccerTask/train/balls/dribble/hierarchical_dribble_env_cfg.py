"""Hierarchical dribble environment configuration.
...
class HierarchicalCommandsCfg:
    """Command specifications for hierarchical dribble.
    
    Same as end-to-end version: command the target velocity for both robot and ball.
    """
...
class HierarchicalActionsCfg:
    """Action specifications for hierarchical dribble.
...
class HierarchicalObservationsCfg(ObservationsCfg):
    """Observation specifications for hierarchical dribble.
    ...
    class HierarchicalPolicyCfg(ObsGroup):
        ...
        # Target command (dribble velocity)
...
class HierarchicalRewardsCfg(RewardsCfg):
    """Reward terms for hierarchical dribble.
...
@configclass
class HierarchicalDribbleEnvCfg(ManagerBasedRLEnvCfg):
    """Configuration for the hierarchical dribble environment.
...
@configclass
class HierarchicalDribblePlayEnvCfg(HierarchicalDribbleEnvCfg):
    """Configuration for the hierarchical dribble environment in play mode."""
