...
from soccerLab.mdp.actions.single.pretrained_vel_policy_action import PreTrainedPolicyAction, PreTrainedPolicyActionCfg
...
class TeamNaviActionCfg(ActionTermCfg):
    ...
    vel_policy_action_cfg: PreTrainedPolicyActionCfg=PreTrainedPolicyActionCfg(
